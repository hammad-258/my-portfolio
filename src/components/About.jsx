  ...
  return (<div className="flex w-full ">
    <main className="w-[60%]">
      <section className="max-w-3xl mx-auto px-6 pt-24">
        <h1 className="text-5xl text-right font-bold text-white jetbrains-mono-regular">
          Hi, I'm Hammad
        </h1>
      </section>
      <section id="about" className="max-w-3xl mx-auto px-6 py-16 pb-0 md:ms-73">
        ...
        <div className="pt-5 ps-5">
          <p className="roboto-regular text-[20px] text-white leading-relaxed">
            Mechanical Engineering undergraduate at ZHCET, Aligarh Muslim University.</p>
        </div>
