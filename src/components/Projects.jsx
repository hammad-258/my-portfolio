const projects = [
  ...
  },
  {
    ...
    description: "A minimal whack-a-mole game written in python and using customTkinter module for GUI.",
...
function ProjectCard({ title, description, tags, link }) {
  return (
    <div
      className="mat-short block bg-transparent border-8 border-white p-5 hover:shadow-none transition-shadow">
      <h3 className="font-semibold roboto-regular text-white mb-2">{title}<a href={link} target="_blank"><svg height="28px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
